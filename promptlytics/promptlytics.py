import datetime
import inspect
from promptlytics.utils import (
    get_api_key,
    promptlytics_api_handler,
    promptlytics_api_handler_async,
)


class PromptLyticsBase(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        if inspect.iscoroutinefunction(function_object):
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                return await promptlytics_api_handler_async(
        ...
        request_end_time = datetime.datetime.now().timestamp()
        return promptlytics_api_handler(
            object.__getattribute__(self, "_function_name"),
            object.__getattribute__(self, "_provider_type"),
            args,
            kwargs,
